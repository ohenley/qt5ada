...
if (NOT TARGET Qt5::Quick3DAssetImport)
    ...
    _populate_Quick3DAssetImport_target_properties(RELEASE "Qt5Quick3DAssetImport.dll" "Qt5Quick3DAssetImport.lib" FALSE)

    if (EXISTS
        "${_qt5Quick3DAssetImport_install_prefix}/bin/Qt5Quick3DAssetImportd.dll"
      AND EXISTS
        "${_qt5Quick3DAssetImport_install_prefix}/lib/Qt5Quick3DAssetImportd.lib" )
        _populate_Quick3DAssetImport_target_properties(DEBUG "Qt5Quick3DAssetImportd.dll" "Qt5Quick3DAssetImportd.lib" FALSE)
    endif()
