...
if (NOT TARGET Qt5::Charts)
    ...
    _populate_Charts_target_properties(RELEASE "Qt5Charts.dll" "Qt5Charts.lib" FALSE)

    if (EXISTS
        "${_qt5Charts_install_prefix}/bin/Qt5Chartsd.dll"
      AND EXISTS
        "${_qt5Charts_install_prefix}/lib/Qt5Chartsd.lib" )
        _populate_Charts_target_properties(DEBUG "Qt5Chartsd.dll" "Qt5Chartsd.lib" FALSE)
    endif()
