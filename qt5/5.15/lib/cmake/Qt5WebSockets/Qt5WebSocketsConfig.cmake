...
if (NOT TARGET Qt5::WebSockets)
    ...
    _populate_WebSockets_target_properties(RELEASE "Qt5WebSockets.dll" "Qt5WebSockets.lib" FALSE)

    if (EXISTS
        "${_qt5WebSockets_install_prefix}/bin/Qt5WebSocketsd.dll"
      AND EXISTS
        "${_qt5WebSockets_install_prefix}/lib/Qt5WebSocketsd.lib" )
        _populate_WebSockets_target_properties(DEBUG "Qt5WebSocketsd.dll" "Qt5WebSocketsd.lib" FALSE)
    endif()
