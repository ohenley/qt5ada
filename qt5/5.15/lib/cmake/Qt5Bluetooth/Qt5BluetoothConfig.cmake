...
if (NOT TARGET Qt5::Bluetooth)
    ...
    _populate_Bluetooth_target_properties(RELEASE "Qt5Bluetooth.dll" "Qt5Bluetooth.lib" FALSE)

    if (EXISTS
        "${_qt5Bluetooth_install_prefix}/bin/Qt5Bluetoothd.dll"
      AND EXISTS
        "${_qt5Bluetooth_install_prefix}/lib/Qt5Bluetoothd.lib" )
        _populate_Bluetooth_target_properties(DEBUG "Qt5Bluetoothd.dll" "Qt5Bluetoothd.lib" FALSE)
    endif()
