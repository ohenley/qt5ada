...
if (NOT TARGET Qt5::TextToSpeech)
    ...
    _populate_TextToSpeech_target_properties(RELEASE "Qt5TextToSpeech.dll" "Qt5TextToSpeech.lib" FALSE)

    if (EXISTS
        "${_qt5TextToSpeech_install_prefix}/bin/Qt5TextToSpeechd.dll"
      AND EXISTS
        "${_qt5TextToSpeech_install_prefix}/lib/Qt5TextToSpeechd.lib" )
        _populate_TextToSpeech_target_properties(DEBUG "Qt5TextToSpeechd.dll" "Qt5TextToSpeechd.lib" FALSE)
    endif()
