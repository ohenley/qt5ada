...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    _populate_RemoteObjects_target_properties(RELEASE "Qt5RemoteObjects.dll" "Qt5RemoteObjects.lib" FALSE)

    if (EXISTS
        "${_qt5RemoteObjects_install_prefix}/bin/Qt5RemoteObjectsd.dll"
      AND EXISTS
        "${_qt5RemoteObjects_install_prefix}/lib/Qt5RemoteObjectsd.lib" )
        _populate_RemoteObjects_target_properties(DEBUG "Qt5RemoteObjectsd.dll" "Qt5RemoteObjectsd.lib" FALSE)
    endif()
