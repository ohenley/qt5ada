...
if (NOT TARGET Qt5::Quick3DUtils)
    ...
    _populate_Quick3DUtils_target_properties(RELEASE "Qt5Quick3DUtils.dll" "Qt5Quick3DUtils.lib" FALSE)

    if (EXISTS
        "${_qt5Quick3DUtils_install_prefix}/bin/Qt5Quick3DUtilsd.dll"
      AND EXISTS
        "${_qt5Quick3DUtils_install_prefix}/lib/Qt5Quick3DUtilsd.lib" )
        _populate_Quick3DUtils_target_properties(DEBUG "Qt5Quick3DUtilsd.dll" "Qt5Quick3DUtilsd.lib" FALSE)
    endif()
