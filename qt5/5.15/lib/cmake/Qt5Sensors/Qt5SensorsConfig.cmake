...
if (NOT TARGET Qt5::Sensors)
    ...
    _populate_Sensors_target_properties(RELEASE "Qt5Sensors.dll" "Qt5Sensors.lib" FALSE)

    if (EXISTS
        "${_qt5Sensors_install_prefix}/bin/Qt5Sensorsd.dll"
      AND EXISTS
        "${_qt5Sensors_install_prefix}/lib/Qt5Sensorsd.lib" )
        _populate_Sensors_target_properties(DEBUG "Qt5Sensorsd.dll" "Qt5Sensorsd.lib" FALSE)
    endif()
