...
if (NOT TARGET Qt5::SerialPort)
    ...
    _populate_SerialPort_target_properties(RELEASE "Qt5SerialPort.dll" "Qt5SerialPort.lib" FALSE)

    if (EXISTS
        "${_qt5SerialPort_install_prefix}/bin/Qt5SerialPortd.dll"
      AND EXISTS
        "${_qt5SerialPort_install_prefix}/lib/Qt5SerialPortd.lib" )
        _populate_SerialPort_target_properties(DEBUG "Qt5SerialPortd.dll" "Qt5SerialPortd.lib" FALSE)
    endif()
