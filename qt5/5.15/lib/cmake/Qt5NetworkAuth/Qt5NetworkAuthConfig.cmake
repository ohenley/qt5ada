...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    _populate_NetworkAuth_target_properties(RELEASE "Qt5NetworkAuth.dll" "Qt5NetworkAuth.lib" FALSE)

    if (EXISTS
        "${_qt5NetworkAuth_install_prefix}/bin/Qt5NetworkAuthd.dll"
      AND EXISTS
        "${_qt5NetworkAuth_install_prefix}/lib/Qt5NetworkAuthd.lib" )
        _populate_NetworkAuth_target_properties(DEBUG "Qt5NetworkAuthd.dll" "Qt5NetworkAuthd.lib" FALSE)
    endif()
