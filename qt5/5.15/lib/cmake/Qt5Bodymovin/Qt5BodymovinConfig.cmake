...
if (NOT TARGET Qt5::Bodymovin)
    ...
    _populate_Bodymovin_target_properties(RELEASE "Qt5Bodymovin.dll" "Qt5Bodymovin.lib" FALSE)

    if (EXISTS
        "${_qt5Bodymovin_install_prefix}/bin/Qt5Bodymovind.dll"
      AND EXISTS
        "${_qt5Bodymovin_install_prefix}/lib/Qt5Bodymovind.lib" )
        _populate_Bodymovin_target_properties(DEBUG "Qt5Bodymovind.dll" "Qt5Bodymovind.lib" FALSE)
    endif()
