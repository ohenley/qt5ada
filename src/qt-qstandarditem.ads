...
package Qt.QStandardItem is

type  QStandardItemItemType is (QStandardItemType, QStandardItemUserType);

for   QStandardItemItemType'size use cardinal'size;
for   QStandardItemItemType use (QStandardItemType => 0,
...
function QStandardItem_create4(rows: Integer; columns: Integer := 1) return QStandardItemH;
pragma Import(C,QStandardItem_create4,"QStandardItem_create4");

function  QStandardItem_data(handle: not null  QStandardItemH; role: QtItemDataRole) return QVariantH;
pragma Import(C,QStandardItem_data,"QStandardItem_data");

procedure QStandardItem_setData(handle: not null  QStandardItemH; value: QVariantH; role: QtItemDataRole);   
...
function QStandardItem_textAlignment(handle: not null  QStandardItemH) return  QtAlignment;   
pragma Import(C,QStandardItem_textAlignment,"QStandardItem_textAlignment");

procedure QStandardItem_setTextAlignment(handle: not null  QStandardItemH; textAlignment: QtAlignment);   
...
function QStandardItem_flags(handle: not null  QStandardItemH) return  QtItemFlags;   
pragma Import(C,QStandardItem_flags,"QStandardItem_flags");

procedure QStandardItem_setFlags(handle: not null  QStandardItemH; flags: QtItemFlags);   
...
function QStandardItem_child(handle: not null  QStandardItemH; row: Integer; column: Integer := 0) return QStandardItemH;   
...
function QStandardItem_takeChild(handle: not null  QStandardItemH; row: Integer; column: Integer := 0) return QStandardItemH;   
...
procedure QStandardItem_sortChildren(handle: not null  QStandardItemH; column: Integer; order: QtSortOrder := QtAscendingOrder);   
...
procedure QStandardItem_read(handle: not null  QStandardItemH; input: QDataStreamH);   
pragma Import(C,QStandardItem_read,"QStandardItem_read");

procedure QStandardItem_write(handle: not null  QStandardItemH; output: QDataStreamH);   
pragma Import(C,QStandardItem_write,"QStandardItem_write");

 function  QStandardItem_isAutoTristate(handle:not null QStandardItemH) return boolean;
 pragma Import(C,QStandardItem_isAutoTristate, "QStandardItem_isAutoTristate");
 
 procedure QStandardItem_setAutoTristate(handle:not null QStandardItemH;tristate:boolean);
 pragma Import(C,QStandardItem_setAutoTristate, "QStandardItem_setAutoTristate");
 
 function  QStandardItem_isUserTristate(handle:not null QStandardItemH) return boolean;
 pragma Import(C,QStandardItem_isUserTristate, "QStandardItem_isUserTristate");
 
 procedure QStandardItem_setUserTristate(handle:not null QStandardItemH;tristate:boolean);
 pragma Import(C,QStandardItem_setUserTristate, "QStandardItem_setUserTristate");
 
--------------------------------------------------------------------------
function QStandardItemModel_create(parent: QObjectH := null) return QStandardItemModelH;    
...
function QStandardItemModel_create2(rows: Integer; columns: Integer; parent: QObjectH := null) return QStandardItemModelH;
pragma Import(C,QStandardItemModel_create2,"QStandardItemModel_create2");

function  QStandardItemModel_index(handle: not null  QStandardItemModelH; row: Integer; column: Integer; parent: QModelIndexH := null) return QModelIndexH;
...
function QStandardItemModel_rowCount(handle: not null  QStandardItemModelH; parent: QModelIndexH := null) return Integer;   
pragma Import(C,QStandardItemModel_rowCount,"QStandardItemModel_rowCount");

function QStandardItemModel_columnCount(handle: not null  QStandardItemModelH; parent: QModelIndexH := null) return Integer;   
pragma Import(C,QStandardItemModel_columnCount,"QStandardItemModel_columnCount");

function QStandardItemModel_hasChildren(handle: not null  QStandardItemModelH; parent: QModelIndexH := null) return Boolean;   
pragma Import(C,QStandardItemModel_hasChildren,"QStandardItemModel_hasChildren");

function  QStandardItemModel_data(handle: not null  QStandardItemModelH; index: QModelIndexH; role: QtItemDataRole := QtDisplayRole) return QVariantH;
...
function  QStandardItemModel_headerData(handle: not null  QStandardItemModelH; section: Integer; orientation: QtOrientation; role: QtItemDataRole := QtDisplayRole) return QVariantH;
...
function QStandardItemModel_insertRows(handle: not null  QStandardItemModelH; row: Integer; count: Integer; parent: QModelIndexH := null) return Boolean;   
pragma Import(C,QStandardItemModel_insertRows,"QStandardItemModel_insertRows");

function QStandardItemModel_insertColumns(handle: not null  QStandardItemModelH; column: Integer; count: Integer; parent: QModelIndexH := null) return Boolean;   
pragma Import(C,QStandardItemModel_insertColumns,"QStandardItemModel_insertColumns");

function QStandardItemModel_removeRows(handle: not null  QStandardItemModelH; row: Integer; count: Integer; parent: QModelIndexH := null) return Boolean;   
pragma Import(C,QStandardItemModel_removeRows,"QStandardItemModel_removeRows");

function QStandardItemModel_removeColumns(handle: not null  QStandardItemModelH; column: Integer; count: Integer; parent: QModelIndexH := null) return Boolean;   
pragma Import(C,QStandardItemModel_removeColumns,"QStandardItemModel_removeColumns");

function QStandardItemModel_flags(handle: not null  QStandardItemModelH; index: QModelIndexH) return  QtItemFlags;   
pragma Import(C,QStandardItemModel_flags,"QStandardItemModel_flags");

function QStandardItemModel_supportedDropActions(handle: not null  QStandardItemModelH) return  QtDropActions;   
...
procedure QStandardItemModel_sort(handle: not null  QStandardItemModelH; column: Integer; order: QtSortOrder := QtAscendingOrder);   
...
function QStandardItemModel_item(handle: not null  QStandardItemModelH; row: Integer; column: Integer := 0) return QStandardItemH;   
...
function QStandardItemModel_insertRow3(handle: not null  QStandardItemModelH; row: Integer; parent: QModelIndexH := null) return Boolean;
pragma Import(C,QStandardItemModel_insertRow3,"QStandardItemModel_insertRow3");

function QStandardItemModel_insertColumn2(handle: not null  QStandardItemModelH; column: Integer; parent: QModelIndexH := null) return Boolean;
pragma Import(C,QStandardItemModel_insertColumn2,"QStandardItemModel_insertColumn2");

function QStandardItemModel_takeItem(handle: not null  QStandardItemModelH; row: Integer; column: Integer := 0) return QStandardItemH;   
...
function  QStandardItemModel_findItems(handle: not null  QStandardItemModelH; text: QStringH; flags: QtMatchFlags := QtMatchExactly; column: Integer := 0) return QObjectListH;
...
function  QStandardItem_create(rows: Integer; columns: Integer := 1) return QStandardItemH;
...
function  QStandardItemModel_create(rows: Integer; columns: Integer; parent: QObjectH := null) return QStandardItemModelH;
...
function  QStandardItemModel_insertRow(handle: not null  QStandardItemModelH; row: Integer; parent: QModelIndexH := null) return Boolean;
function  QStandardItemModel_insertColumn(handle: not null  QStandardItemModelH; column: Integer; parent: QModelIndexH := null) return Boolean;
